...
const ServiceCard: React.FC<ServiceCardProps> = ({
  ...
  <div className="flex flex-col grow px-7 pt-20 w-full text-center bg-teal-500 max-md:px-5 max-md:mt-5 max-md:max-w-full">
    <div className="flex z-10 flex-col items-center px-20 py-16 bg-white shadow-sm max-md:px-5 max-md:mt-10 max-md:max-w-full">
      ...
      />
      <div className="mt-9 text-3xl text-teal-500">{title}</div>
