...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center mt-96 w-full bg-neutral-800 max-md:mt-10 max-md:max-w-full">
      <div className="z-10 -mt-64 w-[80%] max-w-[1440px] max-md:mt-10 max-md:max-w-full rounded-2xl overflow-hidden">
        <iframe
      ...
      <div className="mb-5 mt-28 w-[80%] max-w-[1440px] max-md:max-w-full">
        <div className="flex justify-center gap-5 max-lg:flex-col max-lg:gap-14">
      ...
      <nav className="flex justify-center gap-24 mt-20 px-4 max-w-full sm:text-lg text-white max-md:flex-wrap max-lg:mt-10">
